            ...
            >
                <div className="flex flex-col space-y-8 justify-center items-center">
                    <div className="flex flex-col justify-center items-center space-y-5">
                        {/* Github Icon */}
                        <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/TheMrCorvy"} />
                        {/* Linkedin icon */}
                        <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/gonzalo-salvador-corvalan/"} />
                        {/* Instagram Icon */}
                        <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/themrcorvy/"} />
                    </div>
            ...
            >
                <div className="flex flex-col space-y-24 justify-center items-center">
                    ...
                    <motion.div
                        ...
                        className=""
                    >
                        <a href="mailto:contact@corvalangonzalo.xyz" target={"_blank"} rel="noreferrer">
                    ...
                    <div className="h-24 w-0.5 bg-gray-400 pt-15"></div>
                </div>
            </motion.div>
        </>
    );

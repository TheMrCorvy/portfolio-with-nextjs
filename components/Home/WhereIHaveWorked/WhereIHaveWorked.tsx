...
import TsumugiHotel from "./Descriptions/TsumugiHotel";
...
export default function WhereIHaveWorked() {
    ...
    const GetDescription = () => {
        switch (DescriptionJob) {
            ...
            case "Freelancer":
                return <FeverTokens />;
            case "ServicioAlToque":
                return <IdealFresh />;
            case "Law Firm":
                return <AdvancedAgroManagement />;
        }
    };
    const [DescriptionJob, setDescriptionJob] = useState("Tsumugi Hotel");

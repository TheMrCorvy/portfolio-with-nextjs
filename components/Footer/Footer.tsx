...
const IconsData = [
    { href: "https://github.com/TheMrCorvy", Icon: GithubIcon },
    { href: "https://www.linkedin.com/in/gonzalo-salvador-corvalan/", Icon: LinkedinIcon },
    { href: "https://www.instagram.com/themrcorvy/", Icon: InstagramIcon },
];
    ...
    text-sm  space-y-2  "
                >
                    <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
                        Designed & Built by Gonzalo Corvalán
                    </span>

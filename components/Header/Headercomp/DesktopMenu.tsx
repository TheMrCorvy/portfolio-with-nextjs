    ...
    return (
        <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-6 ">
            ...
            {/* <motion.div
                ...
                className="text-AAsecondary"
            >
                <ReactScrollLink to="SomethingIveStudiedSection" spy={true} smooth={true} offset={-100} duration={200}>
                    &gt; 04. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Studies</span>
